package store.domain.image.common.exception;
...
import store.domain.image.common.error.UserErrorCode;
import store.domain.image.common.exception.user.AddressNotFoundException;
import store.domain.image.common.exception.user.ExistUserException;
import store.domain.image.common.exception.user.FailedToRegisterException;
import store.domain.image.common.exception.user.LogInException;
import store.domain.image.common.exception.user.UserNameNotFoundException;
import store.domain.image.common.exception.user.UserNotFoundException;
import store.domain.image.common.exception.user.UserUnregisterException;
