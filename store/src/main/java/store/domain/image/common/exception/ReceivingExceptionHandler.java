...
import store.domain.image.common.error.ReceivingErrorCode;
import store.domain.image.common.exception.receiving.NoOwnershipException;
import store.domain.image.common.exception.receiving.ReceivingNotFoundException;
