...
import store.domain.image.common.error.TokenErrorCode;
import store.domain.image.common.exception.jwt.TokenException;
import store.domain.image.common.exception.jwt.TokenExpiredException;
import store.domain.image.common.exception.jwt.TokenSignatureException;
