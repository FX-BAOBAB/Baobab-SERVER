package users.common.exception;
...
import users.common.exception.user.AddressNotFoundException;
import users.common.exception.user.ExistUserException;
import users.common.exception.user.FailedToRegisterException;
import users.common.exception.user.LogInException;
import users.common.exception.user.UserNameNotFoundException;
import users.common.exception.user.UserNotFoundException;
import users.common.exception.user.UserUnregisterException;
